    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { id: "figado_achados", label: "Achados (marque o que houver)", type: "multi", cols: 3,
            opts: [["cisto", "cisto(s) simples"], ["nodulo", "nódulo sólido"], ["hemangioma", "hemangioma (aspecto típico)"], ["hepatopatia", "sinais de hepatopatia crônica"], ["calcificacao", "calcificação(ões)"], ["dilatacao_vias", "dilatação de vias biliares"]] },
          { id: "figado_outros", label: "Detalhar / outros", type: "text", cols: 3, showIf: (s) => (s.figado_achados || "").length > 0 },
        ],
      },
      {
        ...
        fields: [
          ...
          { id: "vb_achados", label: "Achados", type: "multi", cols: 3,
            opts: [["polipo", "pólipo(s)"], ["lama", "lama biliar"], ["espessamento", "espessamento parietal"], ["microcalculos", "microcálculos"]] },
          { id: "vb_outros", label: "Detalhar / outros", type: "text", cols: 3, showIf: (s) => (s.vb_achados || "").length > 0 },
        ],
      },
      {
        id: "pancreas", title: "Pâncreas", showIf: abdIn("total", "superior"),
        fields: [
          { id: "panc_visual", label: "Visualização", type: "seg", cols: 1, default: "adequada", opts: [["adequada", "Adequada"], ["prejudicada", "Prejudicada"]] },
          { id: "wirsung", label: "Ducto de Wirsung", type: "num", unit: "mm", cols: 1, opt: true },
          { id: "panc_achados", label: "Achados", type: "multi", cols: 3,
            opts: [["cisto", "cisto(s)"], ["dilatacao", "dilatação do Wirsung"], ["calcificacao", "calcificações"], ["lesao", "lesão focal"]] },
          { id: "panc_outros", label: "Detalhar / outros", type: "text", cols: 3, showIf: (s) => (s.panc_achados || "").length > 0 },
        ],
      },
      {
        ...
        fields: [
          ...
          { id: "baco_achados", label: "Achados", type: "multi", cols: 3,
            opts: [["cisto", "cisto(s)"], ["calcificacao", "calcificação(ões)"], ["lesao", "lesão focal"], ["baco_acessorio", "baço acessório"]] },
          { id: "baco_outros", label: "Detalhar / outros", type: "text", cols: 3, showIf: (s) => (s.baco_achados || "").length > 0 },
        ],
      },
      {
        ...
        fields: [
          ...
          { id: "aorta_achados", label: "Retroperitônio", type: "multi", cols: 3,
            opts: [["linfonodo", "linfonodomegalia"], ["liquido", "líquido livre"], ["massa", "massa retroperitoneal"]] },
          { id: "aorta_outros", label: "Detalhar / outros", type: "text", cols: 3 },
        ],
      },
      {
        id: "rim_d", title: "Rim direito", showIf: abdIn("total", "rins_vias"),
        fields: [
          { id: "rd_comp", label: "Comprimento", type: "num", unit: "mm", cols: 1 },
          { id: "rd_dilatacao", label: "Dilatação pielocalicinal", type: "select", cols: 1, opts: [["ausente", "ausente"], ["leve", "leve"], ["moderada", "moderada"], ["acentuada", "acentuada"]] },
          { id: "rd_calculo", label: "Cálculo", type: "select", cols: 1, opts: [["ausente", "ausente"], ["presente", "presente"]] },
          { id: "rd_calc_maior", label: "Maior cálculo", type: "num", unit: "mm", cols: 1, showIf: (s) => s.rd_calculo === "presente" },
          { id: "rd_achados", label: "Achados", type: "multi", cols: 3,
            opts: [["cisto", "cisto simples"], ["cistos", "cistos múltiplos"], ["cisto_complexo", "cisto complexo"], ["nodulo", "nódulo sólido"], ["perda_dif", "perda da diferenciação corticomedular"]] },
          { id: "rd_outros", label: "Detalhar / outros", type: "text", cols: 3, showIf: (s) => (s.rd_achados || "").length > 0 },
        ],
      },
      {
        id: "rim_e", title: "Rim esquerdo", showIf: abdIn("total", "rins_vias"),
        fields: [
          { id: "re_comp", label: "Comprimento", type: "num", unit: "mm", cols: 1 },
          { id: "re_dilatacao", label: "Dilatação pielocalicinal", type: "select", cols: 1, opts: [["ausente", "ausente"], ["leve", "leve"], ["moderada", "moderada"], ["acentuada", "acentuada"]] },
          { id: "re_calculo", label: "Cálculo", type: "select", cols: 1, opts: [["ausente", "ausente"], ["presente", "presente"]] },
          { id: "re_calc_maior", label: "Maior cálculo", type: "num", unit: "mm", cols: 1, showIf: (s) => s.re_calculo === "presente" },
          { id: "re_achados", label: "Achados", type: "multi", cols: 3,
            opts: [["cisto", "cisto simples"], ["cistos", "cistos múltiplos"], ["cisto_complexo", "cisto complexo"], ["nodulo", "nódulo sólido"], ["perda_dif", "perda da diferenciação corticomedular"]] },
          { id: "re_outros", label: "Detalhar / outros", type: "text", cols: 3, showIf: (s) => (s.re_achados || "").length > 0 },
        ],
      },
      {
        ...
        fields: [
          ...
          { id: "bexiga_achados", label: "Achados", type: "multi", cols: 3,
            opts: [["espessamento", "espessamento parietal"], ["calculo", "cálculo"], ["sedimento", "sedimento/debris"], ["diverticulo", "divertículo"], ["lesao", "lesão vegetante"]] },
          { id: "bexiga_outros", label: "Detalhar / outros", type: "text", cols: 3, showIf: (s) => (s.bexiga_achados || "").length > 0 },
        ],
      },
      {
        ...
        fields: [
          ...
          { id: "prost_achados", label: "Achados", type: "multi", cols: 3,
            opts: [["calcificacoes", "calcificações"], ["nodulo", "nódulo"], ["protrusao", "protrusão intravesical"], ["cisto", "cisto"], ["hpb", "aspecto de HPB"]] },
          { id: "prost_outros", label: "Detalhar / outros", type: "text", cols: 3, showIf: (s) => (s.prost_achados || "").length > 0 },
        ],
      },
